...
color: #dc2626
docs: 119, 9, 12, 35, 51, 155, 75, 79, 122
---
...
@ David Brumley, Bugcrowd / Carnegie Mellon University
David Brumley (CMU/Bugcrowd) explains how to design RL environments and grading oracles for teaching LLMs real vulnerability discovery and exploitation, introducing the "audit task" to prevent reward hacking on multi-bug programs, and shows results from ExploitBench where frontier models achieved full Chrome V8 sandbox-escape exploits.
