...
color: #ea580c
docs: 103, 21, 26, 105, 28, 29, 138, 30, 112, 33, 109, 45, 100, 55, 64, 124, 89, 106, 94
---
...
Argues the one lever engineers actually control is what enters the context window — never past ~25% of budget in a Claude Code session — and tours the injection surface: CLAUDE.md vs. path-scoped rules, hooks, sub-agents, skills, and deferred tool loading. The centerpiece is a brain-inspired memory system — a plain-markdown wiki with an index, Ebbinghaus-style decay scores, and tmux observer sessions that watch the main chat and push or pull knowledge — shown beating an identical wiki-less setup under a five-minute deadline.
